...
class UserAnalytics(Base):
    ...
    top_genres_from_history = Column(JSON, nullable=True)
    top_moods_from_history = Column(JSON, nullable=True)

    avg_duration_from_favorites = Column(Float, nullable=True)
    avg_release_year_from_favorites = Column(Float, nullable=True)
    top_genres_from_favorites = Column(JSON, nullable=True)
    top_moods_from_favorites = Column(JSON, nullable=True)

    total_plays = Column(Integer, nullable=True)
    total_favorites = Column(Integer, nullable=True)
    most_favorite_tracks = Column(JSONB, nullable=True)
