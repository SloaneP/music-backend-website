...
# Получить все события пользователя (можно с ограничением)
...
# Получить или создать агрегат пользователя
...
# Обновить агрегированную аналитику
